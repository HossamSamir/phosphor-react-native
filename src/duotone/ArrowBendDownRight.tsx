...
fill={props.color} {...props}><Rect width={256} height={256} fill="none" /><Polygon points="176 104 224 152 176 200 176 104" opacity={0.2} /><Polygon points="176 104 224 152 176 200 176 104" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={16} /><Path d="M32,56a96,96,0,0,0,96,96h48" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={16} /></Svg>;
}
