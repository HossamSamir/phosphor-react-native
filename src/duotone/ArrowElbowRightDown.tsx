...
fill={props.color} {...props}><Rect width={256} height={256} fill="none" /><Polygon points="128 160 176 208 224 160 128 160" opacity={0.2} /><Polygon points="128 160 176 208 224 160 128 160" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={16} /><Polyline points="32 64 176 64 176 160" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={16} /></Svg>;
}
