...
function FishSimple(props: IconProps) {
  return <Svg viewBox="0 0 256 256" width={props.size} height={props.size} {...props}><Rect width={256} height={256} fill="none" /><Circle cx={156} cy={76} r={10} fill={props.color} /><Path d="M16,183.86C248.25,234.7,227,72.36,220.36,41.8a8,8,0,0,0-6.16-6.16C183.64,29,21.29,7.75,72.1,240" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={12} /><Path d="M201.89,152A96,96,0,0,1,104,54.1" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={12} /></Svg>;
}
